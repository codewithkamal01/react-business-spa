...
function SpecialityCard() {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-3 px-4 md:px-10 py-8">
      {items.map((item, index) => (
        <div
          ...
          <div
            className="flex justify-center items-center w-16 h-16 mx-auto mb-4 rounded-full bg-blue-100 text-3xl group-hover:bg-blue-500 group-hover:text-white transition">
            {item.icon}
          </div>
